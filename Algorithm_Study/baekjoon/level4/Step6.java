...
public class Step6 {
	...
	public static void main(String[] args){
		...
		try {
			int oriNum = Integer.valueOf(br.readLine());
			int leftNum = 0;
			int rightNum = 0;;
			int resultNum = oriNum;
			int tempNum =0;
			int cnt = 0;
			
			do{
				leftNum = resultNum/10;
				rightNum = resultNum%10;
				tempNum = leftNum+rightNum;
				resultNum = Integer.valueOf(String.valueOf(rightNum) + String.valueOf(tempNum%10));
				cnt++;
				
			}while(oriNum!=resultNum);
